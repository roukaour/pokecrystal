	...
	tilecoll DEEP_SAND, DEEP_SAND, DEEP_SAND, DEEP_SAND ; 01
	tilecoll DEEP_GRASS, DEEP_GRASS, DEEP_GRASS, DEEP_GRASS ; 02
	...
	tilecoll WARP_CARPET_LEFT, DEEP_SAND, WARP_CARPET_LEFT, DEEP_SAND ; 0b
	tilecoll DEEP_SAND, DEEP_SAND, WALL, WARP_CARPET_DOWN ; 0c
	tilecoll DEEP_SAND, DEEP_SAND, WARP_CARPET_DOWN, WALL ; 0d
	tilecoll DEEP_SAND, WARP_CARPET_RIGHT, DEEP_SAND, WARP_CARPET_RIGHT ; 0e
	...
	tilecoll DEEP_GRASS, DEEP_GRASS, WALL, WALL ; 33
	...
	tilecoll HEADBUTT_TREE, DEEP_GRASS, DEEP_GRASS, DEEP_GRASS ; 3c
	tilecoll DEEP_GRASS, HEADBUTT_TREE, DEEP_GRASS, DEEP_GRASS ; 3d
	tilecoll DEEP_GRASS, DEEP_GRASS, HEADBUTT_TREE, DEEP_GRASS ; 3e
	tilecoll DEEP_GRASS, DEEP_GRASS, DEEP_GRASS, HEADBUTT_TREE ; 3f
	tilecoll WALL, WALL, WALL, DEEP_SAND ; 40
	tilecoll WALL, WALL, DEEP_SAND, DEEP_SAND ; 41
	tilecoll WALL, WALL, DEEP_SAND, WALL ; 42
	tilecoll WATER, WATER, WATER, WATER ; 43
	tilecoll WALL, DEEP_SAND, WALL, DEEP_SAND ; 44
	tilecoll WALL, DEEP_SAND, DEEP_SAND, DEEP_SAND ; 45
	tilecoll DEEP_SAND, WALL, DEEP_SAND, WALL ; 46
	tilecoll DEEP_GRASS, DEEP_GRASS, DEEP_GRASS, WALL ; 47
	tilecoll WALL, DEEP_SAND, WALL, WALL ; 48
	tilecoll DEEP_SAND, DEEP_SAND, WALL, WALL ; 49
	tilecoll DEEP_SAND, WALL, WALL, WALL ; 4a
	tilecoll HOP_DOWN, DEEP_GRASS, WALL, DEEP_GRASS ; 4b
	...
	tilecoll HOP_DOWN, DEEP_SAND, WALL, DEEP_SAND ; 5a
	tilecoll HEADBUTT_TREE, CUT_TREE, DEEP_GRASS, DEEP_GRASS ; 5b
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, HEADBUTT_TREE, DEEP_GRASS ; 5c
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, DEEP_GRASS, DEEP_GRASS ; 5d
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, DEEP_GRASS, HEADBUTT_TREE ; 5e
	tilecoll DEEP_GRASS, HEADBUTT_TREE, DEEP_GRASS, CUT_TREE ; 5f
	tilecoll HEADBUTT_TREE, DEEP_GRASS, HEADBUTT_TREE, DEEP_GRASS ; 60
	tilecoll HEADBUTT_TREE, HEADBUTT_TREE, HEADBUTT_TREE, HEADBUTT_TREE ; 61
	tilecoll DEEP_GRASS, HEADBUTT_TREE, DEEP_GRASS, HEADBUTT_TREE ; 62
	tilecoll DEEP_GRASS, DEEP_GRASS, CUT_TREE, HEADBUTT_TREE ; 63
	tilecoll HEADBUTT_TREE, DEEP_GRASS, HEADBUTT_TREE, HEADBUTT_TREE ; 64
	tilecoll DEEP_GRASS, DEEP_GRASS, HEADBUTT_TREE, HEADBUTT_TREE ; 65
	tilecoll DEEP_GRASS, HEADBUTT_TREE, HEADBUTT_TREE, HEADBUTT_TREE ; 66
	tilecoll CUT_TREE, DEEP_GRASS, HEADBUTT_TREE, DEEP_GRASS ; 67
	...
	tilecoll WALL, FLOOR, DEEP_SAND, DEEP_SAND ; 74
	tilecoll WALL, WALL, DEEP_SAND, DEEP_SAND ; 75
	tilecoll WATER, WATER, WATER, WATER ; 76
	tilecoll WALL, WALL, DOOR, WALL ; 77
	tilecoll DEEP_SAND, DEEP_SAND, DEEP_SAND, WALL ; 78
